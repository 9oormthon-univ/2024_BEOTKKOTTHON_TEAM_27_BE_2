...
def put_text_on_image(image: Image, text1: str, text2: str, font_type: str, font_color: str, logo_file: str, logo_size: tuple):
    ...
    while True:
        if text2_width > image_width - 100 and font2_max_size > 20:
            font2_max_size = font2_max_size - 20
    ...
    y_position1 = image_height - text1_height
...
if __name__ == "__main__":
    new_image = put_text_on_image(Image.open("image/resized_tteokbokki.jpg"), "소동분식", "#매운맛쟁이 #도전해봐 #매콤한양념", "../font/SDSamliphopangcheTTFOutline.ttf", "white", "logo/logo4.png", (130, 90))
